# -*- coding: utf-8 -*-
#
# Poio API documentation build configuration file, created by
...
sys.path.insert(1, os.path.abspath('../src/poioapi/io/'))
...
latex_documents = [
  ('index', 'PoioAPI.tex', u'Poio API Documentation',
...
man_pages = [
    ('index', 'poioapi', u'Poio API Documentation',
     [u'Peter Bouda'], 1)
]
...
texinfo_documents = [
  ('index', 'PoioAPI', u'Poio API Documentation',
   u'Peter Bouda', 'PoioAPI', 'One line description of project.',
   'Miscellaneous'),
]
